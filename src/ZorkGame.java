...
public class ZorkGame {
	...
	private static void printOutput(int num){
        ...
        case 5: System.out.println("You are standing in the dining room of an old house. \nYou see dust and an empty house.\nYou can (1)exit the south .");
                break;
		case 6: System.out.println("You are standing in the vault room of an old house. \nYou see three walking skeletons.\nYou can to the east (1)the normal door, (2) the secret door.");
		        break;
